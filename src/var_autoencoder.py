...
def train_var(net, trainloader, epochs, learningrate, lossFuncWeights):
    recon_crit = nn.MSELoss()
    miss_crit = nn.KLDivLoss(log_target=True, reduction="batchmean")
    ...
    for epoch in range(epochs):
        ...
        MissLoss = running_loss_miss / len(trainloader)
        train_loss.append(loss)
        train_loss_recon.append(ReconLoss)
        train_loss_miss.append(MissLoss)
